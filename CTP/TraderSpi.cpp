...
namespace Native
{
	...
	void CTraderSpi::OnRspExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspExecOrderInsert(pInputExecOrder, pRspInfo, nRequestID, bIsLast);
	};
	...
	void CTraderSpi::OnRspExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspExecOrderAction(pInputExecOrderAction, pRspInfo, nRequestID, bIsLast);
	};
	...
	void CTraderSpi::OnRspForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspForQuoteInsert(pInputForQuote, pRspInfo, nRequestID, bIsLast);
	};
	...
	void CTraderSpi::OnRspQuoteInsert(CThostFtdcInputQuoteField *pInputQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspQuoteInsert(pInputQuote, pRspInfo, nRequestID, bIsLast);
	};
	...
	void CTraderSpi::OnRspQuoteAction(CThostFtdcInputQuoteActionField *pInputQuoteAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspQuoteAction(pInputQuoteAction, pRspInfo, nRequestID, bIsLast);
	};
	...
	void CTraderSpi::OnRspQryOptionInstrTradeCost(CThostFtdcOptionInstrTradeCostField *pOptionInstrTradeCost, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspQryOptionInstrTradeCost(pOptionInstrTradeCost, pRspInfo, nRequestID, bIsLast);
	};
	...
	void CTraderSpi::OnRspQryOptionInstrCommRate(CThostFtdcOptionInstrCommRateField *pOptionInstrCommRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspQryOptionInstrCommRate(pOptionInstrCommRate, pRspInfo, nRequestID, bIsLast);
	};
	...
	void CTraderSpi::OnRspQryExecOrder(CThostFtdcExecOrderField *pExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		p_OnRspQryExecOrder(pExecOrder, pRspInfo, nRequestID, bIsLast);
	};
	...
	///执行宣告录入请求响应
	void CTraderSpi::OnRspExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspExecOrderInsert(MNConv<ThostFtdcInputExecOrderField^, CThostFtdcInputExecOrderField>::N2M(pInputExecOrder), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///执行宣告操作请求响应
	void CTraderSpi::OnRspExecOrderAction(CThostFtdcInputExecOrderActionField *pInputExecOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspExecOrderAction(MNConv<ThostFtdcInputExecOrderActionField^, CThostFtdcInputExecOrderActionField>::N2M(pInputExecOrderAction), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};


	///询价录入请求响应
	void CTraderSpi::OnRspForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspForQuoteInsert(MNConv<ThostFtdcInputForQuoteField^, CThostFtdcInputForQuoteField>::N2M(pInputForQuote), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///报价录入请求响应
	void CTraderSpi::OnRspQuoteInsert(CThostFtdcInputQuoteField *pInputQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQuoteInsert(MNConv<ThostFtdcInputQuoteField^, CThostFtdcInputQuoteField>::N2M(pInputQuote), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///报价操作请求响应
	void CTraderSpi::OnRspQuoteAction(CThostFtdcInputQuoteActionField *pInputQuoteAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQuoteAction(MNConv<ThostFtdcInputQuoteActionField^, CThostFtdcInputQuoteActionField>::N2M(pInputQuoteAction), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};
	...
	///请求查询投资者品种/跨品种保证金响应
	void CTraderSpi::OnRspQryInvestorProductGroupMargin(CThostFtdcInvestorProductGroupMarginField *pInvestorProductGroupMargin, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryInvestorProductGroupMargin(MNConv<ThostFtdcInvestorProductGroupMarginField^, CThostFtdcInvestorProductGroupMarginField>::N2M(pInvestorProductGroupMargin), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///请求查询交易所保证金率响应
	void CTraderSpi::OnRspQryExchangeMarginRate(CThostFtdcExchangeMarginRateField *pExchangeMarginRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryExchangeMarginRate(MNConv<ThostFtdcExchangeMarginRateField^, CThostFtdcExchangeMarginRateField>::N2M(pExchangeMarginRate), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///请求查询执行宣告响应
	void CTraderSpi::OnRspQryExchangeMarginRateAdjust(CThostFtdcExchangeMarginRateAdjustField *pExchangeMarginRateAdjust, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryExchangeMarginRateAdjust(MNConv<ThostFtdcExchangeMarginRateAdjustField^, CThostFtdcExchangeMarginRateAdjustField>::N2M(pExchangeMarginRateAdjust), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///请求查询汇率响应
	void CTraderSpi::OnRspQryExchangeRate(CThostFtdcExchangeRateField *pExchangeRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryExchangeRate(MNConv<ThostFtdcExchangeRateField^, CThostFtdcExchangeRateField>::N2M(pExchangeRate), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///请求查询二级代理操作员银期权限响应
	void CTraderSpi::OnRspQrySecAgentACIDMap(CThostFtdcSecAgentACIDMapField *pSecAgentACIDMap, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQrySecAgentACIDMap(MNConv<ThostFtdcSecAgentACIDMapField^, CThostFtdcSecAgentACIDMapField>::N2M(pSecAgentACIDMap), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};


	///请求查询期权交易成本响应
	void CTraderSpi::OnRspQryOptionInstrTradeCost(CThostFtdcOptionInstrTradeCostField *pOptionInstrTradeCost, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryOptionInstrTradeCost(MNConv<ThostFtdcOptionInstrTradeCostField^, CThostFtdcOptionInstrTradeCostField>::N2M(pOptionInstrTradeCost), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///请求查询期权合约手续费响应
	void CTraderSpi::OnRspQryOptionInstrCommRate(CThostFtdcOptionInstrCommRateField *pOptionInstrCommRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryOptionInstrCommRate(MNConv<ThostFtdcOptionInstrCommRateField^, CThostFtdcOptionInstrCommRateField>::N2M(pOptionInstrCommRate), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///请求查询执行宣告响应
	void CTraderSpi::OnRspQryExecOrder(CThostFtdcExecOrderField *pExecOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryExecOrder(MNConv<ThostFtdcExecOrderField^, CThostFtdcExecOrderField>::N2M(pExecOrder), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};


	///请求查询询价响应
	void CTraderSpi::OnRspQryForQuote(CThostFtdcForQuoteField *pForQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryForQuote(MNConv<ThostFtdcForQuoteField^, CThostFtdcForQuoteField>::N2M(pForQuote), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};

	///请求查询报价响应
	void CTraderSpi::OnRspQryQuote(CThostFtdcQuoteField *pQuote, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast){
		m_pAdapter->OnRspQryQuote(MNConv<ThostFtdcQuoteField^, CThostFtdcQuoteField>::N2M(pQuote), RspInfoField(pRspInfo), nRequestID, bIsLast);
	};
	...
	///执行宣告通知
	void CTraderSpi::OnRtnExecOrder(CThostFtdcExecOrderField *pExecOrder){
		m_pAdapter->OnRtnExecOrder(MNConv<ThostFtdcExecOrderField^, CThostFtdcExecOrderField>::N2M(pExecOrder));
	};

	///执行宣告录入错误回报
	void CTraderSpi::OnErrRtnExecOrderInsert(CThostFtdcInputExecOrderField *pInputExecOrder, CThostFtdcRspInfoField *pRspInfo){
		m_pAdapter->OnErrRtnExecOrderInsert(MNConv<ThostFtdcInputExecOrderField^, CThostFtdcInputExecOrderField>::N2M(pInputExecOrder), RspInfoField(pRspInfo));
	};

	///执行宣告操作错误回报
	void CTraderSpi::OnErrRtnExecOrderAction(CThostFtdcExecOrderActionField *pExecOrderAction, CThostFtdcRspInfoField *pRspInfo){
		m_pAdapter->OnErrRtnExecOrderAction(MNConv<ThostFtdcExecOrderActionField^, CThostFtdcExecOrderActionField>::N2M(pExecOrderAction), RspInfoField(pRspInfo));
	};


	///询价录入错误回报
	void CTraderSpi::OnErrRtnForQuoteInsert(CThostFtdcInputForQuoteField *pInputForQuote, CThostFtdcRspInfoField *pRspInfo){
		m_pAdapter->OnErrRtnForQuoteInsert(MNConv<ThostFtdcInputForQuoteField^, CThostFtdcInputForQuoteField>::N2M(pInputForQuote), RspInfoField(pRspInfo));
	};

	///报价通知
	void CTraderSpi::OnRtnQuote(CThostFtdcQuoteField *pQuote){
		m_pAdapter->OnRtnQuote(MNConv<ThostFtdcQuoteField^, CThostFtdcQuoteField>::N2M(pQuote));
	};

	///报价录入错误回报
	void CTraderSpi::OnErrRtnQuoteInsert(CThostFtdcInputQuoteField *pInputQuote, CThostFtdcRspInfoField *pRspInfo){
		m_pAdapter->OnErrRtnQuoteInsert(MNConv<ThostFtdcInputQuoteField^, CThostFtdcInputQuoteField>::N2M(pInputQuote), RspInfoField(pRspInfo));
	};

	///报价操作错误回报
	void CTraderSpi::OnErrRtnQuoteAction(CThostFtdcQuoteActionField *pQuoteAction, CThostFtdcRspInfoField *pRspInfo){
		m_pAdapter->OnErrRtnQuoteAction(MNConv<ThostFtdcQuoteActionField^, CThostFtdcQuoteActionField>::N2M(pQuoteAction), RspInfoField(pRspInfo));
	};
