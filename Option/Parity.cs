...
namespace OptionMM
{
    class Parity : DataGridViewRow
    {
        ...
        public Parity(string callInstrumentID, EnumPosiDirectionType callDirection, string putInstrumentID, EnumPosiDirectionType putDirection, double parityInterval)
        {
